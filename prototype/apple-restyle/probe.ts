...
const BASE = "https://cachyharness.tail71b0eb.ts.net:5202";
...
// Nightfall: no node under the floating rail after first fit.
...
console.log(`nightfall nodes overlapping rail after fit: ${overlap}`);
