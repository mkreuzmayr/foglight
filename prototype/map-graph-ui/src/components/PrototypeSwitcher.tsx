...
export const PrototypeSwitcher = ({
  ...
  return (
    <div className="pointer-events-auto fixed bottom-5 left-1/2 z-50 flex -translate-x-1/2 items-center gap-1 rounded-full border border-white/25 bg-white px-1.5 py-1.5 text-black shadow-2xl shadow-black/60">
      <button
        onClick={() => step(-1)}
