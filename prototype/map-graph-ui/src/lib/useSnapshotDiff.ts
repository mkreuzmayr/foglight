// THROWAWAY PROTOTYPE — applies a new map snapshot to React Flow's own store as
// a diff, never as a rebuild.
//
// Why this exists (found with a real-browser probe, probe.ts): in controlled
