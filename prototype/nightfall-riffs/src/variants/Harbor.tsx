// THROWAWAY PROTOTYPE — Riff C: "Harbor".
// Palette: cool blue-black with a cyan accent — instrument-panel cold. Rail
// interior: no accordions. A segmented control (Next / All / Decided) with a
// sliding glass thumb filters one continuous list; the header condenses to a
// progress ring beside a two-line destination.
...
export const Harbor = ({ snap }: { snap: MapSnapshot }) => (
  <GlassShell snap={snap} themeClass="theme-harbor" renderRail={(ctx) => <Rail {...ctx} />} />
);
